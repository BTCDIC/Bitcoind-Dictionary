...
public class EnglishCustomAdapter extends ArrayAdapter<DataModel> implements View.OnClickListener {
    ...
    public EnglishCustomAdapter(ArrayList<DataModel> data, Context context) {
